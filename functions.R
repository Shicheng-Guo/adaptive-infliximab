...
# Script for containing universal functions and objects
# ------------------------------------------------------------------------------
# Create and set working directory
# Specific for the simulation (number of simulations, individuals and the seed)
# Set seed for reproducible results
	seed <- round(runif(1,min = 1,max = 999999),digits = 0)
	set.seed(seed)
	sim.name <- paste("SIM",nsim,"_IND",n,"_seed",seed,sep = "")	# Simulation folder's name
	sim.output.dir <- paste0(output.dir,sim.name,"/")
